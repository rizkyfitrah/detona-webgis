    ...
    <>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
          ...
          />
          <span style={{ fontWeight: 700, fontSize: '18px', letterSpacing: '2px', color: '#F5F5F5', textShadow: '0 0 15px rgba(204,51,51,0.3)' }}>
            DETONA
          </span>
        </div>

        <div style={{ width: '1px', height: '22px', background: 'linear-gradient(to bottom, transparent, rgba(204,51,51,0.5), transparent)' }} />
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#CC3333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
          ...
          {searchQuery && (
            <button
              ...
              style={{ background: 'none', border: 'none', color: '#CC3333', cursor: 'pointer', fontSize: '14px' }}
            >
              ✕
            </button>
          )}
        ...
        <div style={{ position: 'relative' }}>
          ...
          {layerOpen && (
            ...
            >
              ...
              >
                <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#3B82F6', opacity: visibleDivisi.supply_chain ? 1 : 0.4 }} />
                <span>Gudang (SC)</span>
              </button>
              <button
              ...
              >
                <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#F97316', opacity: visibleDivisi.operasional ? 1 : 0.4 }} />
        ...
        {/* Jam */}
        <div style={{ fontSize: '12px', color: '#B0B0B0', fontWeight: 300, letterSpacing: '1px', fontVariantNumeric: 'tabular-nums' }}>
          {time}
        </div>

        {/* Tombol Help (walkthrough) */}
        <div style={{ position: 'relative' }}>
          <button
